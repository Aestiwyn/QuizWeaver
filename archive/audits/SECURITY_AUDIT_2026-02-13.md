> **Historical snapshot (2026-02-13).** This is the original audit record.
> Its risk counts and remediation state are superseded by
> `docs/SECURITY_AUDIT.md`; do not use it as a current security conclusion.
